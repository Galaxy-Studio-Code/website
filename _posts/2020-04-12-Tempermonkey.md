...
function(e) {
    ...
    function gets(e) {
        return localStorage.getItem(`fdd.$ {
            tid
        }.$ {
            e
        }`)
    ...
    async
    function randIP() {
        const e = await config.get("fakeip", "auto");
        if ("disabled" !== e) return "auto" === e ? utils.randIP() : e
    }
    function antiAnticheat() {
        ...
        realWindow.screenfull && (realWindow.screenfull = {
            request: () = >{},
            exit: () = >{},
            toggle: () = >{},
            raw: !1,
